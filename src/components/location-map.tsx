...
export default function LocationMap() {
    ...
    { 
      ...
      icon: (isActive: boolean) => (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M1.61902 17.8096H17.8095" stroke={isActive ? "white" : "#9F0E52"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M13.7619 1.61914H5.66668C3.23811 1.61914 2.42859 3.06819 2.42859 4.85724V17.8096H17V4.85724C17 3.06819 16.1905 1.61914 13.7619 1.61914Z" stroke={isActive ? "white" : "#9F0E52"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M11.3819 12.1428H8.03853C7.62567 12.1428 7.27759 12.4828 7.27759 12.9038V17.8095H12.1347V12.9038C12.1428 12.4828 11.8028 12.1428 11.3819 12.1428Z" stroke={isActive ? "white" : "#9F0E52"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M9.71423 4.85718V8.9048" stroke={isActive ? "white" : "#9F0E52"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M7.69043 6.8811H11.738" stroke={isActive ? "white" : "#9F0E52"} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      )
    },
    { 
      ...
      icon: (isActive: boolean) => (
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M15.8125 15.0666L11 17.7736L6.1875 15.0666V12.2065L4.8125 11.4426V15.8707L11 19.3512L17.1875 15.8707V11.4426L15.8125 12.2065V15.0666Z" fill={isActive ? "white" : "#9F0E52"}/>
          <path d="M11 1.97559L1.375 6.96632V8.15801L11 13.5051L19.25 8.92191V12.7188H20.625V6.96632L11 1.97559ZM17.875 8.11286L16.5 8.87671L11 11.9324L5.5 8.87671L4.125 8.11286L3.172 7.58339L11 3.52444L18.828 7.58339L17.875 8.11286Z" fill={isActive ? "white" : "#9F0E52"}/>
        </svg>
      )
    },
    { 
      ...
      icon: (isActive: boolean) => (
       <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4.58333 2.5L2.5 17.5" stroke={isActive ? "white" : "#9F0E52"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M15.418 2.5L17.4865 17.4813" stroke={isActive ? "white" : "#9F0E52"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M10 2.5V5" stroke={isActive ? "white" : "#9F0E52"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M10 14.5833V17.4999" stroke={isActive ? "white" : "#9F0E52"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M10 8.33325V11.2499" stroke={isActive ? "white" : "#9F0E52"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      )
    },
    { 
  ...
  const locationData: Record<string, Array<{ name: string; distance: string }>> = {
    hospital: [
      { name: "Apex Multi-Speciality Hospital ", distance: "1 km" },
      { name: "Navya Multi-Speciality Hospital", distance: "5 km" },
      { name: "Omega Multi-Speciality Hospital", distance: "7 km" },
      { name: "Sparsh Hospital Yelahanka", distance: "8 km" },
    ],
    schools: [
      { name: "EuroSchool North Campus ", distance: "1.7 km" },
      { name: "Hilton High Innovative School", distance: "3 km" },
      { name: "Orchids The International School", distance: "4 km" },
      { name: "Ryan International, Yelahanka", distance: "5 km" }
    ],
    connectivity: [
      { name: "Manyata Tech Park", distance: "8 km" },
      { name: "Outer Ring Road (ORR)", distance: "5 km" },
      { name: "Hebbal Flyover / Bellary Road ", distance: "8 km" },
      { name: "Upcoming Metro Station", distance: "4 km" },
      { name: "Yelahanka Junction Railway Station", distance: "8 km" },
    ],

    entertainment: [
      { name: "The Galleria Mall", distance: "5 km" },
      { name: "Elements Mall", distance: "7 km" },
      { name: "Phoenix Mall of Asia", distance: "9 km" },
      { name: "Esteem Mall", distance: "10 km" },
    ],
  }
